...
struct EditPersonView: View {
    ...
    init(person: Person) {
        ...
        _selectedDay = State(initialValue: Int(person.birthDay))
        _selectedMonth = State(initialValue: Int(person.birthMonth))
        _interests = State(initialValue: person.interests ?? "")
        _giftIdeas = State(initialValue: person.giftIdeas ?? "")
    }
